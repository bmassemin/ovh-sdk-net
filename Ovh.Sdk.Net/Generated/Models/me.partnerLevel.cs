...
namespace _me_partnerLevel {
    ...
    public class Level {
        ...
        public required _me_partnerLevel.LevelTypeEnum _Level { get; set; }//;
        
        // Key: msa Type: boolean FullType: boolean
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("msa")]
        public required System.Boolean Msa { get; set; }//;
        ...
        public required _me_partnerLevel.RequirementLoSEnum Requirement { get; set; }//;
    }
