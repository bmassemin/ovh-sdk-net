...
namespace _dedicated_server {
    ...
    public class BackupFtp {
        ...
        public _dedicated_server.BackupStorageTypeEnum Type { get; set; }//;
    ...
    public class Task {
        ...
        public _dedicated.TaskFunctionEnum Function { get; set; }//;
    ...
    public class Access {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("type")]
        public _dedicated_server.AccessTypeEnum Type { get; set; }//;
    ...
    public class AvailabilityByRegion {
        ...
        public _dedicated_server.AvailabilityZones[] AvailabilityZones { get; set; }//;
    ...
    public class AvailabilityZones {
        ...
        public _dedicated_server.AvailabilityZonesEnum AvailabilityZone { get; set; }//;
    }
    ...
    public class BMC {
        ...
        public _dedicated_server.BmcSupportedFeatures SupportedFeatures { get; set; }//;
    }
    ...
    public class BackupCloud {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("status")]
        public _dedicated_server_backup.BackupStatus Status { get; set; }//;
    ...
    public class BillingAddon {
        ...
        public _dedicated_server.AddonFamilyEnum Family { get; set; }//;
    ...
    public class BiosSettingsSupport {
        ...
        public _dedicated_server.BiosSettingsSupportSgxOptions SgxOptions { get; set; }//;
    }
    ...
    public class Dedicated {
        ...
        public _dedicated_server.PowerStateEnum PowerState { get; set; }//;
        ...
        public _dedicated_server.StateEnum State { get; set; }//;
        ...
        public _dedicated_server.SupportLevelEnum SupportLevel { get; set; }//;
    }
    ...
    public class Firewall {
        ...
        public string _Firewall { get; set; }//;
        ...
        public _dedicated_server.FirewallModeEnum Mode { get; set; }//;
    ...
    public class HardwareRaidConfiguration {
        ...
        public long DiskSpanSize { get; set; }//;
        
        // Key: mode Type: dedicated.server.HardwareSpecificationsRaidHardEnum FullType: 
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("mode")]
        public _dedicated_server.HardwareSpecificationsRaidHardEnum Mode { get; set; }//;
    ...
    public class HardwareRaidController {
        ...
        public _dedicated_server.HardwareRaidDiskGroup[] Disks { get; set; }//;
    ...
    public class HardwareRaidDiskGroup {
        ...
        public _complexType.UnitAndValue<string> Speed { get; set; }//;
        
        // Key: type Type: dedicated.server.DiskTypeEnum FullType: 
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("type")]
        public _dedicated_server.DiskTypeEnum Type { get; set; }//;
    }
    ...
    public class HardwareRaidProfile {
        ...
        public _dedicated_server.HardwareRaidController[] Controllers { get; set; }//;
    }
    ...
    public class HardwareRaidSize {
        ...
        public _dedicated_server.HardwareRaidConfiguration[] Configurations { get; set; }//;
    }
    ...
    public class HardwareSpecifications {
        ...
        public _dedicated_server.BootModeEnum BootMode { get; set; }//;
    ...
    public class HardwareSpecificationsExpansionCard {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("type")]
        public _dedicated_server.HardwareSpecificationsExpansionCardTypeEnum Type { get; set; }//;
    }
    ...
    public class InstallationProgressSteps {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("status")]
        public _dedicated_server.InstallationProgressStatusEnum Status { get; set; }//;
    }
    ...
    public class Interfaces {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("type")]
        public _dedicated_server.NetworkingTypeEnum Type { get; set; }//;
    }
    ...
    public class IpOrderableDetails {
        ...
        public _dedicated_server.IpBlockSizeEnum[] BlockSizes { get; set; }//;
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("type")]
        public _dedicated_server.IpTypeOrderableEnum Type { get; set; }//;
    }
    ...
    public class Ipmi {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("supportedFeatures")]
        public _dedicated_server.IpmiSupportedFeatures SupportedFeatures { get; set; }//;
    }
    ...
    public class IpmiSupportedFeatures {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("kvmipHtml5URL")]
        public bool KvmipHtml5URL { get; set; }//;
        
        // Key: kvmipJnlp Type: boolean FullType: 
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("kvmipJnlp")]
        public bool KvmipJnlp { get; set; }//;
        
        // Key: serialOverLanSshKey Type: boolean FullType: 
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("serialOverLanSshKey")]
        public bool SerialOverLanSshKey { get; set; }//;
        
        // Key: serialOverLanURL Type: boolean FullType: 
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("serialOverLanURL")]
        public bool SerialOverLanURL { get; set; }//;
    }
    ...
    public class Netboot {
        ...
        public _dedicated_server.BootTypeEnum BootType { get; set; }//;
    ...
    public class NetworkSpecifications {
        ...
        public _dedicated_server.VmacDetails Vmac { get; set; }//;
    ...
    public class Networking {
        ...
        public _dedicated_server.Interfaces[] Interfaces { get; set; }//;
    ...
    public class OlaAvailableModes {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("interfaces")]
        public _dedicated_server.OlaInterface[] Interfaces { get; set; }//;
    ...
    public class OlaDetails {
        ...
        public _dedicated_server.OlaAvailableModes[] AvailableModes { get; set; }//;
    ...
    public class OlaInterface {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("type")]
        public _dedicated_server.OlaInterfaceModeEnum Type { get; set; }//;
    }
    ...
    public class Operation {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("function")]
        public _dedicated.OperationFunctionEnum Function { get; set; }//;
    ...
    public class Option {
        ...
        public _dedicated_server.OptionEnum _Option { get; set; }//;
        
        // Key: state Type: dedicated.server.OptionStateEnum FullType: dedicated.server.OptionStateEnum
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("state")]
        public _dedicated_server.OptionStateEnum State { get; set; }//;
    }
    ...
    public class PlannedIntervention {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("status")]
        public _dedicated.PlannedInterventionStatusEnum Status { get; set; }//;
        
        // Key: type Type: dedicated.PlannedInterventionTypeEnum FullType: dedicated.PlannedInterventionTypeEnum
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("type")]
        public _dedicated.PlannedInterventionTypeEnum Type { get; set; }//;
        ...
        public System.DateTime WantedStartDate { get; set; }//;
    }
    ...
    public class ServerBurst {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("status")]
        public _dedicated_server.BurstStatusEnum Status { get; set; }//;
    }
    ...
    public class SupportReplaceHddInfo {
        ...
        public string Disk_serial { get; set; }//;
    ...
    public class UsbKeyOrderableDetails {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("capacity")]
        public _dedicated_server.UsbKeyCapacityEnum[] Capacity { get; set; }//;
    ...
    public class VirtualMac {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("type")]
        public _dedicated_server.VmacTypeEnum Type { get; set; }//;
    }
    ...
    public class netbootOption {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("option")]
        public _dedicated_server.BootOptionEnum Option { get; set; }//;
    ...
    public class spla {
        ...
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("status")]
        public _dedicated_server.SplaStatusEnum Status { get; set; }//;
        
        // Key: type Type: dedicated.server.SplaTypeEnum FullType: dedicated.server.SplaTypeEnum
        [System.Text.Json.Serialization.JsonPropertyNameAttribute("type")]
        public _dedicated_server.SplaTypeEnum Type { get; set; }//;
    }
