...
namespace Ovh.Sdk.Net.AuthProviders
{
    ...
    public class OAuth2 : IAuthProvider
    {
        ...
        public OAuth2(string endpoint)
        {
            _clientId = Environment.GetEnvironmentVariable("OVH_CLIENT_ID") ?? throw new InvalidOperationException();
            _clientSecret = Environment.GetEnvironmentVariable("OVH_CLIENT_SECRET") ?? throw new InvalidOperationException();
            _endpoint = endpoint;
        }
